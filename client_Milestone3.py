...
def receive():
    ...
    if data[2] == "Squished":
        ...
        squished.append(0)
    if cur_offset in remaining_offset:
...
while len(remaining_offset) > 0:
    ...
    elapsed_burst_time = burst_time - start_time
    xxtime.append(elapsed_burst_time)
...
plt.scatter(xxtime, burst, label= "Burst", color= "orange", s=10) 
